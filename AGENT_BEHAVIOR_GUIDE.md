...
1. **Load local authority:** Always read `./AGENTS.md` and `./_ai_operating_system/` from your working directory
...
5. **Validate before commit:** Run `scripts/check-context-isolation.sh` and `scripts/check-git-discipline.sh`
...
- `./_ai_operating_system/` — Your repo's operating layer (not parent-directory _ai_operating_system/)
...
I read ./_ai_operating_system/AGENT_CONTEXT_CONTAINMENT_CONTRACT.md
...
ls -la ./_ai_operating_system/           # Local _ai_operating_system/ directory
...
# ~/.MyAppZ/_AI_AGENT_SYSTEM_TEMPLATE/_ai_operating_system/
...
├── _ai_operating_system/                        ← Local authority
├── .cursor/
...
npm test
bash scripts/check-context-isolation.sh .
bash scripts/check-git-discipline.sh .
...
- [ ] Validation checks pass:
  - [ ] `bash scripts/check-git-discipline.sh .` → `git_discipline_ok`
  - [ ] `bash scripts/check-context-isolation.sh .` → `context_isolation_ok`
...
- ✓ Local `_ai_operating_system/` exists
- ✓ No symlinks to parent directories
- ✓ No hardcoded parent-directory paths
- ✓ Runtime code doesn't reference `_ai_operating_system/`
...
My actual rules are in ./AGENTS.md and ./_ai_operating_system/"
```
...
```bash
cat .cursorrules
# Output: "Load your local AGENTS.md and _ai_operating_system/"
...
| Load operating layer | `./_ai_operating_system/` | `~/.MyAppZ/_AI_AGENT_SYSTEM_TEMPLATE/_ai_operating_system/` |
