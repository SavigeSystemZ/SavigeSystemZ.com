...
export const archiveCatalog: ArchiveEntryRecord[] = [
  ...
  withCategoryLabel({
    id: "archive-006",
    slug: "opnsense-edge-firewall",
    title: "OPNsense Edge Firewall Build",
    summary: "Production-ready OPNsense configuration with IDS/IPS, WireGuard VPN, and strict VLAN segregation.",
    category: "OPNSENSE_BUILDS",
    visibility: "public",
    featured: true,
    stageLabel: "Infrastructure kit",
    artifactFormat: "Config XML / Deployment Guide",
    details:
      "A fully documented OPNsense build used for the foundry's edge network, including Unbound DNS over TLS, Suricata tuning, and segment isolation.",
    tags: ["OPNsense", "Firewall", "Networking", "Security"],
    stackItems: ["FreeBSD", "WireGuard", "Suricata", "Unbound"],
    artifactUrl: "/archive/opnsense-edge-firewall",
    artifactLabel: "View Build Details",
    createdAt: "2026-05-15T12:00:00.000Z",
  }),
  withCategoryLabel({
    id: "archive-007",
    slug: "payload-delivery-framework",
    title: "Stealth Payload Delivery Framework",
    summary: "Educational framework for understanding modern payload staging and evasion techniques.",
    category: "HACKING_CONTENT",
    visibility: "public",
    featured: false,
    stageLabel: "Offensive research",
    artifactFormat: "Source code / Whitepaper",
    details:
      "A deep dive into in-memory execution, AMSI bypass strategies, and syscall evasion. For authorized red-teaming and defensive engineering.",
    tags: ["Red Team", "Malware Dev", "Evasion", "Security"],
    stackItems: ["C/C++", "Assembly", "Windows API", "Python"],
    artifactUrl: "/archive/payload-delivery-framework",
    artifactLabel: "Read Whitepaper",
    createdAt: "2026-05-20T12:00:00.000Z",
  }),
  withCategoryLabel({
    id: "archive-008",
    slug: "neon-genesis-game",
    title: "Neon Genesis: Terminal Protocol",
    summary: "A custom-developed terminal-based puzzle game combining hacking mechanics and narrative.",
    category: "GAMES",
    visibility: "public",
    featured: true,
    stageLabel: "Playable release",
    artifactFormat: "Binary / WebAssembly",
    details:
      "An interactive fiction and puzzle game where you play as an operator navigating compromised networks. Fully custom engine.",
    tags: ["Games", "Terminal", "Interactive Fiction", "Puzzle"],
    stackItems: ["Rust", "WebAssembly", "React", "TUI"],
    artifactUrl: "/archive/neon-genesis-game",
    artifactLabel: "Play Demo",
