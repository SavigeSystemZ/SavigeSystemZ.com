...
2. You have local copies of `AGENTS.md` and `_ai_operating_system/` — **your authority**
...
cat _ai_operating_system/AGENT_CONTEXT_CONTAINMENT_CONTRACT.md  # Context isolation rules
cat AGENT_BEHAVIOR_GUIDE.md                  # How to behave (this repo)

# 3. Validate your environment
bash scripts/check-context-isolation.sh .  # Should output: context_isolation_ok
bash scripts/check-git-discipline.sh .     # Should output: git_discipline_ok
```
...
test -f AGENTS.md && test -d _ai_operating_system/ && echo "✓ Ready"
...
├── _ai_operating_system/AGENT_CONTEXT_CONTAINMENT_CONTRACT.md
├── _ai_operating_system/GIT_REMOTE_AND_SYNC_PROTOCOL.md
├── _ai_operating_system/DEPLOYMENT_BOUNDARY_PROTOCOL.md
...
├── _ai_operating_system/                            ← NOT your authority
...
2. **_ai_operating_system/AGENT_CONTEXT_CONTAINMENT_CONTRACT.md** — Context isolation rules
3. **_ai_operating_system/GIT_REMOTE_AND_SYNC_PROTOCOL.md** — Git workflow rules
4. **_ai_operating_system/DEPLOYMENT_BOUNDARY_PROTOCOL.md** — What deploys vs what stays

## Final Checklist

- [ ] I'm reading `./AGENTS.md` (not parent-directory AGENTS.md)
- [ ] I'm using `./_ai_operating_system/` (not parent-directory _ai_operating_system/)
